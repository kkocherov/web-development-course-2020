...
* Видео на YouTube:   
  ...
  1. [Простенький сайт с авторизацией. Часть 5: загрузка файлов и пагинация](https://www.youtube.com/watch?v=PLQ3FFXl5Io&list=PLLS1dXP92A-B3c_7ExVa5OwdXgAu2fgkq&index=15)
  1. [Простенький сайт с авторизацией. Часть 6: обработка ошибок](https://www.youtube.com/watch?v=CQEwSqi4gio&list=PLLS1dXP92A-B3c_7ExVa5OwdXgAu2fgkq&index=16)
  1. [Простенький сайт с авторизацией. Часть 7: практика с Heroku](https://www.youtube.com/watch?v=VHjLbLheLdQ&list=PLLS1dXP92A-B3c_7ExVa5OwdXgAu2fgkq&index=18)
...
* Видео на YouTube:   
  1. [Начинаем работать с СУБД](https://youtu.be/2ajAWFsO3wA)
  1. [СУБД: Подзапросы, джойны, связи](https://youtu.be/jENnOxyzuZE)
  1. [Практика: исключения, БД в heroku, переменные среды](https://youtu.be/iQ0Uq2d1QEc)


### Неделя 7

* Видео на YouTube:   
  1. [Что еще умеют СУБД](https://youtu.be/GrA22dfs31o)
  1. [Автозагрузка классов, миграции, тесты, управление зависимостями в PHP](https://youtu.be/524iMZfOp_s)
  1. [Практика: Фреймворки и Laravel](https://youtu.be/Ek8SfirxMwk)

### Неделя 8
#### ООП и дизайн

* Видео на YouTube:   
  1. [Дизайн ПО и первые два принципа SOLID](https://youtu.be/LzCnKhIYWP0)
...
1. Страница с формой регистрации   
...
1. 7-12 различных страниц;
1. понятный бизнес процесс:   
кто, когда, при каких условиях, при помощи каких ресурсов, что и 
зачем будет делать на вашем ресурсе;
1. пользователи могут выполнять CRUD операции как минимум с 3 различными сущностями;
1. на ресурсе представлено как минимум два типа пользователей с различными правами и возможностями; 
1. страничка с анатилической информацией; 
1. регистрация и авторизация пользователей; 

#### Функциональные и технические требования:
1. ссылка на репозиторий с понятным, хорошо структурированным кодом;
1. не позволяйте пользователю вводить некорректные значения в текстовые поля сущностей.   
Проверяйте входные данные.
1. уведомляйте пользователя о совершаемых им ошибках или о совершении запрещенных в рамках процесса действиях.  
Приложение не должно молча без объяснения причины падать с 500;
1. запрещено удаление сущностей, которое приведет к нарушению ограничений связей на уровне БД;
1. при удалении любых сущностей необходимо либо спрашивать подтверждение пользователя, либо реализовать возможность отмены операции удаления.

Защита проекта представляет из себя короткую презентацию (минут 5-10) готового рабочего сервиса, а не кода.
Проект можно делать на пару с коллегой или другом. Можно использовать любые языки, технологии, фреймворки, библиотеки. Интеграция с внешними
сервисами приветствуется.

Аналитика на на сайте может быть представлена двумя-тремя графиками. Например: количество посещений сайта, 
самые популярные товары, самые обсуждаемые посты, самые активные пользователи. 

Регистрация может происходть как самостоятельно пользователем. Либо по инициативе (приглашению) 
уже существуюещго пользователя в системе.

Перед началом разработки тему и идею итогового проекта нужно предварительно согласовать. 

#### Пример:
[Описание итогового проекта](https://docs.google.com/document/d/17Ami8tD6VAYlySQm2TbNW_9ft2_jTB049B4vzD1sQ5c/edit?usp=sharing)
